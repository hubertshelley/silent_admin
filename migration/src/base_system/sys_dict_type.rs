...
pub(crate) async fn up(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
    ...
    if manager.has_table(SysDictType::Table.to_string()).await? {
        manager
    ...
    manager
        .create_table(
            Table::create()
                ...
                .append_base_columns()
                .col(
                    ColumnDef::new(SysDictType::Name)
                        .string_len(100)
                        .default("")
                        .comment("字典名称"),
                )
                .col(
                    ColumnDef::new(SysDictType::Type)
                        .string_len(100)
                        .default("")
                        .comment("字典类型"),
                )
                ...
                .col(
                    ColumnDef::new(SysDictType::Remark)
                        .string()
    ...
    manager
        .create_index(
            Index::create()
                .name("idx_sys_dict_type_type_uniq")
                .table(SysDictType::Table)
                .col(SysDictType::Type)
                .unique()
                .to_owned(),
        )
        .await?;
